...
public class UpdateCustomer extends javax.swing.JFrame {
    ...
    public UpdateCustomer(String cid, DashboardListener dashboardListener){
        this.cid = cid;
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(organization, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        if(firstName.getText().isBlank()){
            ...
            if(n == 0){
                new CustomerDBController().update(cid, firstName.getText(), lastName.getText(), phoneNumber.getText(), 
                        organization.getText(), position.getText(), address.getText());
                JOptionPane.showMessageDialog(rootPane, "Customer's details was successfully updated!");
                dashboardListener.updateCustomerTable();
                dispose();
            }
        }
    ...
    public javax.swing.JTextField organization;
