 ...
 * @author Vienji
 */
public class AddExpense extends javax.swing.JFrame implements GeneralJournalListener{
    ...
    public AddExpense(User user, DashboardListener listener){
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(addExpense, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cancel))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void addExpenseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addExpenseActionPerformed
        if(date.getDate() != null){
            ...
            if(accountList.isEmpty() || !hasBothDebitAndCredit(accountList)){
                ...
                if(n == 0){
                    new EntryDBController().addExpensesEntry(formattedDate, 
                            new Dashboard().stringEscape(description.getText()), currentUser.getId(), accountList, documentPath);
                    JOptionPane.showMessageDialog(rootPane, "Expenses transaction was successfully added!");                                      
                    listener.updateExpensesTable();
                    dispose();
                }          
            } 
        } else {
