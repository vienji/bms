 ...
 * @author Vienji
 */
public class UpdateEntry extends javax.swing.JFrame implements GeneralJournalListener{
    ...
    public UpdateEntry(User user, DashboardListener listener, ArrayList<Account> accountList, String id){
        initComponents();
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        if(date.getDate() != null){
            ...
            if(accountList.isEmpty() || !hasBothDebitAndCredit(accountList)){
                ...
                if(n == 0){
                    new EntryDBController().updateEntry(id, formattedDate, 
                            new Dashboard().stringEscape(description.getText()), currentUser.getId(), accountList);
                    JOptionPane.showMessageDialog(rootPane, "Journal entry was successfully updated!");                                      
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
